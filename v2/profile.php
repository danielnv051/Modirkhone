...
<div class="saken-items-bill saken-alone">
    <div class="saken-build">
        <div class="saken-info">
            ...
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><?php echo $sym_sim; ?> همراه اول</span>
                </div>
                <input type="text" class="form-control" id="debt" value="">
            </div>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><?php echo $sym_sim; ?> ایرانسل</span>
                </div>
                <input type="text" class="form-control" id="debt" value="">
            </div>
    ...
    <div class="items-button">
        <button class="btn btn-info w-100" id="vorood"><?php echo $sym_save; ?> ذخیره</button>
    </div>
