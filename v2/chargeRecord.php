...
<div class="saken-items-bill saken-alone">
    <div class="saken-build">
        <div class="saken-info">
            ...
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><?php echo $sym_payment_way; ?>نحوه واریز</span>
                </div>
                <select class="form-control" id="how_to_pay" style="border: 1px dashed silver;">
            ...
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><?php echo $sym_image; ?>تصویر سند</span>
                </div>
    ...
    <div class="items-button">
        <button class="btn btn-info w-100" id="vorood"><?php echo $sym_save; ?> ثبت پرداخت شارژ</button>
    </div>
