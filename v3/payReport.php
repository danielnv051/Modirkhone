...
<fieldset>
    <legend>
        <div class="tarikh text-center">1402/07/19 <br />16:15:10</div>
        <span class="input-group-text my_pay" style="width:70%"><?php echo $sym_good_pay; ?><span>واریز شارژ مهر</span></span>
            ...
            <div class="saken-info">
                ...
                <div class="input-group">
                    <div class="input-group-prepend ">
                        <span class="input-group-text"><?php echo $sym_good_pay; ?>مبلغ : <span>1,000,000 ریال</span></span>
                    </div>
                </div>
                <div class="input-group">
                    <div class="input-group-prepend">
