<?php $title = 'گزارش هزینه های ساختمان';
...
<fieldset>
    <legend>
        ...
        <span class="input-group-text my_pay" style="width:70%"><?php echo $sym_good_pay; ?><span>هزینه تعمیر آسانسور </span></span>
    ...
    <div class="saken-items-bill saken-alone" id="pr_saken_bill">
        <div class="saken-build">
            <div class="saken-info">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><?php echo $sym_good_pay; ?>سهم واحد : <span>30,000,000 ریال</span></span>
                    </div>
                </div>

            </div>
            <div class="saken-factor">
                <img src="img/factor.png" alt="فاکتور هزینه ساختمان">
            </div>
        </div>
    </div>
</fieldset>
