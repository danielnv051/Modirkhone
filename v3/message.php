...
<div class="saken-items-bill saken-alone">
        ...
        <div class="saken-info">
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><?php echo $sym_chat; ?>انتخاب مدیر </span>
                </div>
                <select name="manager" id="" class="form-control" style="border: 1px dashed silver;">
                    <option value="1">مدیر1</option>
                    <option value="2">مدیر2</option>
                </select>
            </div>
            <div class="input-group">
                <div class="input-group-prepend">
    ...
    <div class="items-button">
        <button class="btn btn-info w-100" id="vorood"><?php echo $sym_chat_send; ?> ارسال پیام به مدیر ساختمان</button>
    </div>
