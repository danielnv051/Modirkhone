...
for (const provinceData of data) {
    ...
    option.text = provinceData.province;
...
function updateCities() {
    ...
    const selectedProvinceData = data.find(item => item.province === selectedProvince);
    if (selectedProvinceData) {
        for (const city of selectedProvinceData.cities) {
            const option = document.createElement("option");
            option.value = city;
            option.text = city;
