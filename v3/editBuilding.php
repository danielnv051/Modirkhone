        ...
        <div class="saken-build">
            <div class="saken-info">
                <fieldset>
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><?php echo $building; ?> استان <span class="red">*</span></span>
                        </div>
                        <input type="text" id="state" class="form-control" name="state" readonly value="خراسان رضوی">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><?php echo $building; ?> شهر<span class="red">*</span></span>
                        </div>
                        <input type="text" class="form-control" name="city" readonly value="مشهد">
