...
<div class="saken-items-bill saken-alone">
    <div class="saken-build">
        <div class="saken-info">
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="debt" disabled value="1">
            </div>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><?php echo $sym_meter; ?> متراژ (متر مربع)</span>
                </div>
                <input type="text" class="form-control" id="g_p" disabled value="5">
            </div>
            <div class="input-group">
                <div class="input-group-prepend">
                ...
                <input type="hidden" class="form-control" id="o_p" value="350000">
            </div>
            <div class="final_pay">
    ...
    <div class="items-button">
        <button class="btn btn-info w-100" id="vorood"><?php echo $sym_request; ?> درخواست رزرو</button>
    </div>
