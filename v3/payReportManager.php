<?php $title = 'گزارش درآمد ساختمان';
require_once('header.php');
$return_link = "manager.php?id=" . $_GET['id'];
...
<fieldset>
    <legend>
        <div class="tarikh">1402/07/19</div>
        <span class="input-group-text my_pay" style="width:70%"><?php echo $sym_good_pay; ?><span>درآمد از استخر ساختمان</span></span>
            ...
            <div class="saken-info">
                ...
                <div class="input-group">
                    <div class="input-group-prepend ">
                        <span class="input-group-text"><?php echo $sym_good_pay; ?>مبلغ : <span>10,000,000 ریال</span></span>
                    </div>
                </div>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><?php echo $sym_good_pay; ?>نوع واریز : <span>کارت به کارت</span></span>
                    </div>
                </div>
